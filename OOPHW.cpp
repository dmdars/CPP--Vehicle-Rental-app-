    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case 'c':
            {
                ...
                while(no_of_days > 365)
                {
                    cout << "The maximal number of days are 365. Please re-input again" << endl;
                    cout << "number of days: ";
                    cin >> no_of_days;
                }
            ...
            case 'l':
            {
                ...
                for(int i=0; i<no_simulation; i++)
                {
                    ...
                    // cout << "no " << vehicle_no << " date " << date << " for days " << no_of_days << endl;
                    if(agency.isFree(vehicle_no, date, no_of_days))
                    {
                        customer_no++;
